...
'''
numeros = [[], []] # para a criação do exercicio, foi necessaria criar listas dentro
                   # da lista principal
for c in range(1, 8):
...
print(f'Os numeros pares foram {sorted(numeros[0])}') # pode ser ordenado antes de exibir
