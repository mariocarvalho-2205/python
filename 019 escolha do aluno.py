...
ficha = [n1, n2, n3, n4] = criamos uma lista e atribuimos a ela as variaveis com os dados coletados
'''
...
alunos = []
cont = 1
qtd = int(input('\033[31mQuantos ficha serão sorteados?\033[m '))
while cont <= qtd:
    nomes = input('\033[36mDigite o nome dos ficha:\033[m ')
...
# random.choice(ficha) - Escolhe aleatorio uma opção dentro de uma lista
print(alunos)
